...
(defx11* XKeysymToString : _ulong -> _string)
...
(defx11* XCreateSimpleWindow : _XDisplay-pointer _ulong _int _int _uint _uint _uint _ulong _ulong -> _ulong)
(defx11* XGetSelectionOwner : _XDisplay-pointer _ulong -> _ulong)
...
(defx11* XRootWindow : _XDisplay-pointer _int -> _ulong)
(defx11* XDefaultRootWindow : _XDisplay-pointer -> _ulong)
(defx11* XRootWindowOfScreen : _Screen-pointer -> _ulong)
...
(defx11* XIconifyWindow : _XDisplay-pointer _ulong _int -> _int)
(defx11* XWithdrawWindow : _XDisplay-pointer _ulong _int -> _int)
(defx11* XGetWMColormapWindows : _XDisplay-pointer _ulong _pointer (_ptr i _int) -> _int)
...
(defx11* XCirculateSubwindowsDown : _XDisplay-pointer _ulong -> _int)
...
(defx11* XMapRaised : _XDisplay-pointer _ulong -> _int)
(defx11* XMapSubwindows : _XDisplay-pointer _ulong -> _int)
(defx11* XMapWindow : _XDisplay-pointer _ulong -> _int)
...
(defx11* XRemoveFromSaveSet : _XDisplay-pointer _ulong -> _int)
...
(defx11* XResizeWindow : _XDisplay-pointer _ulong _uint _uint -> _int)
(defx11* XRestackWindows : _XDisplay-pointer (_ptr i _ulong) _int -> _int)
(defx11* XRotateBuffers : _XDisplay-pointer _int -> _int)
(defx11* XRotateWindowProperties : _XDisplay-pointer _ulong (_ptr i _ulong) _int _int -> _int)
(defx11* XScreenCount : _XDisplay-pointer -> _int)
(defx11* XSendEvent : _XDisplay-pointer _ulong _int _long _XEvent-pointer -> _int)
...
(defx11* XSetWindowBorder : _XDisplay-pointer _ulong _ulong -> _int)
(defx11* XSetWindowBorderPixmap : _XDisplay-pointer _ulong _ulong -> _int)
(defx11* XSetWindowBorderWidth : _XDisplay-pointer _ulong _uint -> _int)
(defx11* XSetWindowColormap : _XDisplay-pointer _ulong _ulong -> _int)
...
(defx11* XUnmapWindow : _XDisplay-pointer _ulong -> _int)
(defx11* XVendorRelease : _XDisplay-pointer -> _int)
(defx11* XWarpPointer : _XDisplay-pointer _ulong _ulong _int _int _uint _uint _int _int -> _int)
(defx11* XWidthMMOfScreen : _Screen-pointer -> _int)
(defx11* XWidthOfScreen : _Screen-pointer -> _int)
(defx11* XWindowEvent : _XDisplay-pointer _ulong _long _XEvent-pointer -> _int)
...
(defx11* XFilterEvent : _XEvent-pointer _ulong -> _int)
...
(defx11* XTextPropertyToStringList : _XTextProperty-pointer _pointer (_ptr i _int) -> _int)

(defx11* XAddPixel : _XImage-pointer _long -> _int)
(defx11* XGetWMHints : _XDisplay-pointer _ulong -> _XWMHints-pointer)
(defx11* XGetWMIconName : _XDisplay-pointer _ulong _XTextProperty-pointer -> _int)
(defx11* XAllocClassHint : -> _XClassHint-pointer)
(defx11* XGetWMName : _XDisplay-pointer _ulong _XTextProperty-pointer -> _int)
(defx11* XGetWMNormalHints : _XDisplay-pointer _ulong _XSizeHints-pointer (_ptr i _long) -> _int)
(defx11* XGetWMSizeHints : _XDisplay-pointer _ulong _XSizeHints-pointer (_ptr i _long) _ulong -> _int)
